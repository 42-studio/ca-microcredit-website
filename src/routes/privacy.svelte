<div class="wrapper">
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        to C.A. Micro Credit Enterprise, xyz.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to C.A. Micro Credit Enterprise Website,
        accessible from
        <a
          href="https://ca-microcredit.joshlucpoll.dev"
          rel="external nofollow noopener"
          target="_blank">https://ca-microcredit.joshlucpoll.dev</a
        >
      </p>
    </li>
    <li>
  ...
  <ul>
    <li>By email: hello@ca-micro.credit</li>
  </ul>
</div>
